...
import {DaofinPlugin as PluginTemplate} from '../../generated/templates';
import {JudiciaryChanged} from '../../generated/templates/DaofinPlugin/DaofinPlugin';
import {PLUGIN_REPO_ADDRESS} from '../../utils/constants';
import {getJudiciaryId} from '../../utils/proposals';
import {
...
export function handleInstallationPrepared(event: InstallationPrepared): void {
  ...
  if (preparationId) {
    ...
    pluginEntity.creationBlockNumber = event.block.number;
    pluginEntity.save();
    // Create template
